...
=======
	@Query(value ="SELECT count(*) from verification_request where year(closed_date) = ?1 and doc_status in ('UN_Approved','Uni_Auto_Approved','SVD_Approved','UN_Approved_Pass')", nativeQuery = true)
>>>>>>> f8432659b3e44447d49c9452d04c5e98e03ca4ad
